...
export const Sidebar: React.FC<SidebarProps> = ({ currentTab, setCurrentTab, userName, isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`w-64 bg-[#1a1a1a] text-white min-h-screen flex flex-col fixed left-0 top-0 z-50 transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full'
        } md:translate-x-0`}>
